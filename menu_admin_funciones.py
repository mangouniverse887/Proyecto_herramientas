...
def menu_reportes():
    while True:
        ...
        print(f"{ROJO}7. Volver al menú principal{RESET}")
        opcion = input("\nElige un reporte(1-7): ")
        if opcion == "1":
    ...
    while True:
        ...
        if sub_op == "1":
            ...
            if usuarios.crear_usuario(id_u, nom, ape, tel, dire, t_usu):
                ...
                print("Error: Datos inválidos o el usuario ya existe.")
        elif sub_op == "2":
            ista = usuarios.listar_usuarios()
            for u in lista:
            ...
            if usuarios.eliminar_usuario(id_u):
                ...
                print("Error al eliminar (Usuario no encontrado)")
        elif sub_op == "5":
            break

def gestionar_herramientas():
    while True:
        print(f"\n{VERDE}1. Crear | 2. Listar | 3. Buscar | 4. Actualizar | 5. Inactivar {RESET}|{ROJO} 6. Volver al menú{RESET}")
